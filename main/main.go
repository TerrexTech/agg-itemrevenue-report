...
func main() {
	...
	// 	revenueResult := report.RevenueSoldWeight(avgSoldReport)
	...
	// 	reportColl, err := CreateCollection(client, "agg_report_itemrevenue", &report.SoldReport{})
	// 	if err != nil {
	// 		err = errors.Wrap(err, "Error in MongoCollection")
	// 		log.Fatalln(err)
	// 	}
